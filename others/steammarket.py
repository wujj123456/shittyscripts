...
trade_items = {
    'nekopara_vol0': [
        '385800-NEKOPARA%20Vol.%200%20Booster%20Pack',
        '385800-Coconut',
        '385800-Cinnamon',
        '385800-Azuki',
        '385800-Chocola',
...
def print_item_prices(category, item_list):
    table = []
    for s in item_list:
        url = card_url(s)
        ...
        t.join()
    print(category)
    print(tabulate(zip(item_list, table)))


def main():
    print_item_prices('nekopara_vol0', trade_items['nekopara_vol0'])
